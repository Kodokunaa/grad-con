...
?>">
    ...
    <a href="<?php 
echo \url('');
?>/alumni_officer/alumni_list.php">
    ...
    <a href="<?php 
echo \url('');
?>/alumni_officer/events_list.php"
       class="<?php 
echo basename(\request()->server->all()['PHP_SELF']) == 'events_list.php' ? 'active' : '';
?>">
     ...
     <a href="<?php 
echo \url('');
?>/alumni_officer/archive.php"
       class="<?php 
echo basename(\request()->server->all()['PHP_SELF']) == 'archive.php' ? 'active' : '';
?>">
