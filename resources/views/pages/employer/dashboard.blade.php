...
?>/employer/posted_job.php" class="btn-soft">View My Jobs</a>
        ...
        <section class="hero-card">
            <div class="hero-content">
                ...
                <div class="hero-chip"><?php 
echo number_format($appsCount);
?> Total Applications</div>
            </div>
        </section>

        <section class="stats-grid">
            <div class="stats-card"><div class="stats-top"><div><div class="stats-label">Job Posts</div><div class="stats-number"><?php 
echo number_format($jobsCount);
?></div></div><div class="stats-icon">💼</div></div><div class="stats-note">All jobs created by your account.</div></div>
            <div class="stats-card"><div class="stats-top"><div><div class="stats-label">Open Jobs</div><div class="stats-number"><?php 
echo number_format($openJobsCount);
?></div></div><div class="stats-icon">🟢</div></div><div class="stats-note">Currently visible and active jobs.</div></div>
            <div class="stats-card"><div class="stats-top"><div><div class="stats-label">Applications</div><div class="stats-number"><?php 
echo number_format($appsCount);
?></div></div><div class="stats-icon">📥</div></div><div class="stats-note">Total applications received.</div></div>
            <div class="stats-card"><div class="stats-top"><div><div class="stats-label">Pending</div><div class="stats-number"><?php 
echo number_format($pendingCount);
?></div></div><div class="stats-icon">⏳</div></div><div class="stats-note">Waiting for your review.</div></div>
            <div class="stats-card"><div class="stats-top"><div><div class="stats-label">For Interview</div><div class="stats-number"><?php 
echo number_format($interviewCount);
?></div></div><div class="stats-icon">📅</div></div><div class="stats-note">Applicants selected for interview.</div></div>
            <div class="stats-card"><div class="stats-top"><div><div class="stats-label">Accepted</div><div class="stats-number"><?php 
echo number_format($acceptedCount);
?></div></div><div class="stats-icon">✅</div></div><div class="stats-note">Accepted for the next step.</div></div>
            <div class="stats-card"><div class="stats-top"><div><div class="stats-label">Hired</div><div class="stats-number"><?php 
echo number_format($hiredCount);
?></div></div><div class="stats-icon">🎉</div></div><div class="stats-note">Officially hired applicants.</div></div>
            <div class="stats-card"><div class="stats-top"><div><div class="stats-label">Rejected</div><div class="stats-number"><?php 
echo number_format($rejectedCount);
?></div></div><div class="stats-icon">❌</div></div><div class="stats-note">Applications not selected.</div></div>
            <div class="stats-card"><div class="stats-top"><div><div class="stats-label">Job Offers</div><div class="stats-number"><?php 
echo number_format($offersCount);
?></div></div><div class="stats-icon">🎁</div></div><div class="stats-note">Total job offers sent to alumni.</div></div>
            <div class="stats-card"><div class="stats-top"><div><div class="stats-label">Offers Accepted</div><div class="stats-number"><?php 
echo number_format($offersAcceptedCount);
?></div></div><div class="stats-icon">✔️</div></div><div class="stats-note">Alumni who accepted offers.</div></div>
            <div class="stats-card"><div class="stats-top"><div><div class="stats-label">Offers Pending</div><div class="stats-number"><?php 
echo number_format($offersPendingCount);
?></div></div><div class="stats-icon">⌛</div></div><div class="stats-note">Awaiting alumni response.</div></div>
            <div class="stats-card"><div class="stats-top"><div><div class="stats-label">Offers Declined</div><div class="stats-number"><?php 
echo number_format($offersDeclinedCount);
?></div></div><div class="stats-icon">👋</div></div><div class="stats-note">Alumni who declined offers.</div></div>
        </section>
...
?>
            ...
            <aside class="panel-card">
                ...
                <div class="summary-list">
                    <div class="summary-item"><span class="summary-label">Open Jobs</span><span class="summary-value"><?php 
echo number_format($openJobsCount);
?></span></div>
                    <div class="summary-item"><span class="summary-label">Closed Jobs</span><span class="summary-value"><?php 
echo number_format($closedJobsCount);
?></span></div>
                    <div class="summary-item"><span class="summary-label">Pending</span><span class="summary-value"><?php 
echo number_format($pendingCount);
?></span></div>
                    <div class="summary-item"><span class="summary-label">For Interview</span><span class="summary-value"><?php 
echo number_format($interviewCount);
?></span></div>
                    <div class="summary-item"><span class="summary-label">Accepted</span><span class="summary-value"><?php 
echo number_format($acceptedCount);
?></span></div>
                    <div class="summary-item"><span class="summary-label">Hired</span><span class="summary-value"><?php 
echo number_format($hiredCount);
?></span></div>
                    <div class="summary-item"><span class="summary-label">Rejected</span><span class="summary-value"><?php 
echo number_format($rejectedCount);
?></span></div>
                    <div class="summary-item"><span class="summary-label">Job Offers</span><span class="summary-value"><?php 
echo number_format($offersCount);
?></span></div>
                </div>
...
?>
            ...
            <aside class="panel-card">
                ...
                <div class="summary-list">
                    <div class="summary-item"><span class="summary-label">Total Offers</span><span class="summary-value"><?php 
echo number_format($offersCount);
?></span></div>
                    <div class="summary-item"><span class="summary-label">Accepted</span><span class="summary-value"><?php 
echo number_format($offersAcceptedCount);
?></span></div>
                    <div class="summary-item"><span class="summary-label">Pending Response</span><span class="summary-value"><?php 
echo number_format($offersPendingCount);
?></span></div>
                    <div class="summary-item"><span class="summary-label">Declined</span><span class="summary-value"><?php 
echo number_format($offersDeclinedCount);
?></span></div>
                </div>
