...
?></div>
            ...
            <div class="stat-card">
                ...
                <div class="stat-number"><?php 
echo number_format($totalEmployers);
?></div>
            ...
            <div class="stat-card">
                ...
                <div class="stat-number"><?php 
echo number_format($employedCount);
?></div>
            ...
            <div class="stat-card">
                ...
                <div class="stat-number"><?php 
echo number_format($unemployedCount);
?></div>
        ...
        <section class="main-grid">
            ...
            <aside class="panel-card">
                ...
                <div class="summary-list">
                    <div class="summary-item"><span class="summary-label">Total Alumni</span><span class="summary-value"><?php 
echo number_format($totalAlumni);
?></span></div>
                    <div class="summary-item"><span class="summary-label">Employers</span><span class="summary-value"><?php 
echo number_format($totalEmployers);
?></span></div>
                    <div class="summary-item"><span class="summary-label">Total Jobs</span><span class="summary-value"><?php 
echo number_format($totalJobs);
?></span></div>
                    <div class="summary-item"><span class="summary-label">Aligned Jobs</span><span class="summary-value"><?php 
echo number_format($alignedCount);
?></span></div>
                    <div class="summary-item"><span class="summary-label">Not Aligned</span><span class="summary-value"><?php 
echo number_format($notAlignedCount);
?></span></div>
                </div>
...
echo json_encode($employmentLabels);
?>;
const employmentTotals = <?php 
echo json_encode($employmentTotals);
?>;
const alignmentLabels = <?php 
echo json_encode($alignmentLabels);
?>;
const alignmentTotals = <?php 
echo json_encode($alignmentTotals);
?>;

const totalJobs = <?php 
echo (int) $totalJobs;
?>;
const totalEmployers = <?php 
echo (int) $totalEmployers;
?>;
const totalAlumni = <?php 
echo (int) $totalAlumni;
?>;
const employedCount = <?php 
echo (int) $employedCount;
?>;
const unemployedCount = <?php 
echo (int) $unemployedCount;
?>;
const alignedCount = <?php 
echo (int) $alignedCount;
?>;
const notAlignedCount = <?php 
echo (int) $notAlignedCount;
?>;
const employmentRate = <?php 
echo json_encode($employmentRate);
?>;
const alignmentRate = <?php 
echo json_encode($alignmentRate);
?>;
