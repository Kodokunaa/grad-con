...
<div class="content">
    ...
    <div class="filter-card">
            ...
            <div>
                <?php if ($alumniCourse !== ''): ?>
                    <div class="course-badge">
                        Your course: <?php echo htmlspecialchars($alumniCourse); ?>
                    </div>
                <?php endif; ?>
            </div>

            <div class="job-count">
                <?php echo count($jobs); ?> open job(s) found
            </div>
        </div>
        ...
        <form method="GET" action="" class="search-form">
            ...
            <?php if ($search !== ''): ?>
                <a href="<?php echo BASE_URL; ?>/alumni/jobs.php" class="clear-btn">Clear</a>
            <?php endif; ?>
        </form>
    ...
    <?php if (count($jobs) === 0): ?>
        <div class="empty-card">
            ...
            <?php if ($search !== ''): ?>
                No jobs matched your search for "<?php echo htmlspecialchars($search); ?>".
            <?php else: ?>
            ...
            <?php foreach ($jobs as $j): ?>
                <div class="job-card">
                    ...
                    <div class="job-description">
                        <?php echo htmlspecialchars(mb_strimwidth($j['description'], 0, 160, "...")); ?>
                    </div>

                    <div class="card-footer">
                        <span class="view-details">Review the details before applying</span>

                        <a class="btn-orange" href="<?php echo BASE_URL; ?>/alumni/apply.php?job_id=<?php echo (int)$j['id']; ?>">
                            Apply Now
                        </a>
                    </div>
    ...
    <a class="back-link" href="<?php echo BASE_URL; ?>/alumni/dashboard.php">← Back to Dashboard</a>
