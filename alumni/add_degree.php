    ...
    if ($school_name === "") {
        ...
        try {
            ...
            $ins->execute([
                ...
                $school_name,
                $degree,
                ($start_year !== "" ? (int)$start_year : null),
                ($end_year !== "" ? (int)$end_year : null)
            ]);

            add_log($pdo, $id, "EDUCATION_ADDED", "Added educational background: " . $school_name);
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <select name="degree" class="form-select-custom" required>
                        ...
                        <?php foreach ($degree_options as $option): ?>
                            <option value="<?php echo htmlspecialchars($option); ?>" <?php echo (($_POST['degree'] ?? '') === $option) ? 'selected' : ''; ?>>
                ...
                <div class="col-md-3">
                    ...
                    <input
                        ...
                        maxlength="4"
                        value="<?php echo htmlspecialchars($_POST['start_year'] ?? ''); ?>"
                    >
                </div>
                ...
                <div class="col-md-3">
                    ...
                    <input
                        ...
                        maxlength="4"
                        value="<?php echo htmlspecialchars($_POST['end_year'] ?? ''); ?>"
                    >
                </div>
                        ...
                        <?php foreach ($education_list as $edu): ?>
                            <tr>
                                ...
                                <td class="muted-small">
                                    <?php echo !empty($edu['created_at']) ? date("F j, Y", strtotime($edu['created_at'])) : ''; ?>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    <?php endif; ?>
