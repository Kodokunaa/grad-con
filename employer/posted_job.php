...
try {
    $postedJobsFields = [
        ...
        "j.company",
        "j.employer_company",
        $hasEmailAddress ? "j.email_address" : "NULL AS email_address",
        $hasStartDate ? "j.start_date" : "NULL AS start_date",
        $hasEndDate ? "j.end_date" : "NULL AS end_date",
        "j.location",
        "j.job_type",
        "j.description",
        "j.is_open",
    ...
    $error = "Database error loading posted jobs: " . $e->getMessage();
}
?>
...
<div class="content">
    ...
    <div class="page-header">
        ...
        <div class="header-actions">
            <a href="<?php echo BASE_URL; ?>/employer/post_job.php" class="btn-header btn-orange">
                <i class="fas fa-plus"></i> Post New Job
            </a>

            <a href="<?php echo BASE_URL; ?>/employer/applications.php" class="btn-header">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="small-text">
                                    <?php echo e($job['employer_company'] ?: $job['company']); ?>
                                </div>
                            </td>

                            <td><?php echo e($job['job_type'] ?: 'N/A'); ?></td>

                            <td><?php echo e($job['location'] ?: 'N/A'); ?></td>

                            <td>
                                <?php echo !empty($job['start_date']) ? e(date("F j, Y", strtotime($job['start_date']))) : 'N/A'; ?>
                            </td>

                            <td>
                                <?php echo !empty($job['end_date']) ? e(date("F j, Y", strtotime($job['end_date']))) : 'N/A'; ?>
                            </td>

                            <td>
                                <span class="badge <?php echo $scheduleClass; ?>">
                                    <?php echo e($scheduleStatus); ?>
                                </span>
                            </td>

                            <td>
                                <span class="badge <?php echo $isOpen ? 'badge-open' : 'badge-closed'; ?>">
