    ...
    <div class="form-card">
        <form method="POST" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <input type="text" name="title" class="form-control-custom" value="<?php echo htmlspecialchars($event["title"]); ?>" required>
            </div>

            <div class="form-group">
                <label class="form-label">Content</label>
                <textarea name="content" rows="5" class="form-textarea-custom" required><?php echo htmlspecialchars($event["content"]); ?></textarea>
            </div>
            ...
            <div class="form-group">
                ...
                <?php if (!empty($event["image"])): ?>
                    <div class="preview-wrapper">
                        <img src="<?php echo BASE_URL; ?>/uploads/events/<?php echo htmlspecialchars($event["image"]); ?>" class="preview-img" alt="Preview">
                    </div>
                <?php endif; ?>
            </div>
            ...
            <div class="actions">
                ...
                <a href="<?php echo BASE_URL; ?>/alumni_officer/events_list.php" class="btn-outline-custom">Back</a>
            </div>
        </form>
    </div>
</div>
