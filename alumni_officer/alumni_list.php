...
foreach ($alumni as $a) {
    if (!empty($a['course'])) $courseOptions[] = trim($a['course']);
    if (!empty($a['batch_year'])) $batchOptions[] = trim($a['batch_year']);
}
...
if (file_exists(__DIR__ . "/../includes/alumni_officer_sidebar.php")) {
...
<div class="content">
    ...
    <div class="stats-grid">
        <div class="stat-card">
            ...
            <div>
                <div class="stat-value"><?php echo number_format(count($alumni)); ?></div>
        ...
        <div class="stat-card">
            <div class="stat-icon">🎓</div>
            <div>
                <div class="stat-value"><?php echo number_format(count($courseOptions)); ?></div>
        ...
        <div class="stat-card">
            <div class="stat-icon">📅</div>
            <div>
                <div class="stat-value"><?php echo number_format(count($batchOptions)); ?></div>
    ...
    <a class="back-link" href="<?php echo BASE_URL; ?>/alumni_officer/dashboard.php">← Back to Dashboard</a>
</div>
