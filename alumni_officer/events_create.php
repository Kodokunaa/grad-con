...
try {
    if (!column_exists($pdo, 'events', 'post_start_date')) {
        $pdo->exec("ALTER TABLE events ADD COLUMN post_start_date DATETIME NULL AFTER image");
    }
...
if ($_SERVER["REQUEST_METHOD"] === "POST" && $error === "") {
    ...
    $post_start_date = to_mysql_datetime($_POST["post_start_date"] ?? "");
    $post_end_date = to_mysql_datetime($_POST["post_end_date"] ?? "");
    $image_name = null;

    if ($title === "" || $content === "") {
        $error = "Title and content are required.";
    } elseif (!empty($_POST["post_start_date"]) && $post_start_date === null) {
        $error = "Invalid start date.";
    } elseif (!empty($_POST["post_end_date"]) && $post_end_date === null) {
        ...
        if (!empty($_FILES["image"]["name"])) {
            ...
            } elseif (($_FILES["image"]["size"] ?? 0) > 3 * 1024 * 1024) {
        ...
        <form method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea
                    ...
                    required
                ><?php echo e($_POST['content'] ?? ''); ?></textarea>
            </div>
                ...
                <div class="form-grid">
                    <div class="form-group" style="margin-bottom:0;">
                        ...
                        <input
                            ...
                            class="form-control-custom"
                            value="<?php echo e($_POST['post_start_date'] ?? ''); ?>"
                        >
                    ...
                    <div class="form-group" style="margin-bottom:0;">
                        ...
                        <input
                            ...
                            name="post_end_date"
                            class="form-control-custom"
                            value="<?php echo e($_POST['post_end_date'] ?? ''); ?>"
                        >
            ...
            <div class="actions">
                ...
                <a class="btn-outline-custom" href="<?php echo BASE_URL; ?>/alumni_officer/events_list.php">View Posts</a>
            </div>
        </form>
    </div>
</div>
