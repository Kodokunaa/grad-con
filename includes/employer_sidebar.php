...
$currentUserName = $_SESSION['user']['fullname'] ?? 'User';
$currentUserRole = strtolower($_SESSION['user']['role'] ?? 'employer');
$roleLabels = [
    'admin' => 'Admin',
    'alumni' => 'Alumni',
    'employer' => 'Employer',
...
<?php if (!defined('TOPBAR_INCLUDED')): ?>
<div class="app-header">
    <div class="header-left">
        ...
        <div>
            ...
            <div class="header-tagline"><?php echo htmlspecialchars($currentUserRoleLabel, ENT_QUOTES, 'UTF-8'); ?></div>
        </div>
    </div>

    <div class="header-right">
        <div class="header-user">
            <div class="header-user-avatar"><?php echo strtoupper(substr(trim($currentUserName), 0, 1)); ?></div>
            <div><?php echo htmlspecialchars($currentUserName, ENT_QUOTES, 'UTF-8'); ?></div>
        </div>
        <a class="header-action" href="<?php echo BASE_URL; ?>/auth/logout.php">Logout</a>
    </div>
</div>
...
<div class="sidebar" id="appSidebar">
    ...
    <div class="submenu" id="applicantsSubmenu">
        ...
        <a href="<?php echo BASE_URL; ?>/employer/job_offers.php"
           class="<?php echo basename($_SERVER['PHP_SELF']) == 'job_offers.php' ? 'active' : ''; ?>">
            <i class="fas fa-gift"></i> View Job Offers
        </a>
    </div>

    <a href="<?php echo BASE_URL; ?>/employer/alumni_list.php"
       class="<?php echo basename($_SERVER['PHP_SELF']) == 'alumni_list.php' ? 'active' : ''; ?>">
