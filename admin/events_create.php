...
try {
    ...
    $error = "Database setup error: " . $ex->getMessage();
}

if ($_SERVER["REQUEST_METHOD"] === "POST") {
    $title = trim($_POST["title"] ?? "");
    $content = trim($_POST["content"] ?? "");
    $post_start_date = trim($_POST["post_start_date"] ?? "");
    $post_end_date = trim($_POST["post_end_date"] ?? "");
    $image_name = null;
    ...
    if ($title === "" || $content === "") {
        ...
        if ($error === "") {
            try {
                ...
                $error = "Post error: " . $ex->getMessage();
            }
        }
    }
}
            ...
            <div class="form-body">
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <div class="actions">
                        ...
                        <a class="btn-outline-custom" href="<?php echo BASE_URL; ?>/admin/events_list.php">← View Posts</a>
                    </div>
                </form>
            </div>
        </section>
