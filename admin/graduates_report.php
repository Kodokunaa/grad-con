...
$report_type = $_GET['report_type'] ?? 'batch';
...
$reportTitle = ($report_type === 'batch')
    ? 'Graduate Statistics Report per Batch'
    : 'Graduate Statistics Report per Department';
...
<div class="content">
    <div class="page-header no-print">
        ...
        <div class="top-actions">
            <a class="action-btn" href="<?php echo BASE_URL; ?>/admin/graduates_stats.php">Back</a>
        ...
        <form method="GET" class="filter-form">
            <div class="form-group">
                ...
                <select name="report_type" id="report_type" class="form-control">
                    <option value="batch" <?php echo $report_type === 'batch' ? 'selected' : ''; ?>>Per Batch</option>
                    <option value="department" <?php echo $report_type === 'department' ? 'selected' : ''; ?>>Per Department</option>
                </select>
            </div>
    ...
    <div class="summary-card">
        <div class="summary-grid">
            <div class="summary-box">
                ...
                <div class="summary-value"><?php echo $totalGraduates; ?></div>
            </div>

            <div class="summary-box">
                <div class="summary-label">Current Report</div>
                <div class="summary-value" style="font-size:20px;">
                    <?php echo ($report_type === 'batch') ? 'Per Batch' : 'Per Department'; ?>
                </div>
            </div>
    ...
    <div class="report-card">
            ...
            <table class="custom-table">
                <thead>
                    <tr>
                        ...
                        <th><?php echo ($report_type === 'batch') ? 'Batch Year' : 'Department / Course'; ?></th>
                ...
                <tbody>
                    <?php foreach ($reportData as $index => $row): ?>
                        <tr>
                            ...
                            <td class="row-label"><?php echo htmlspecialchars($row['label']); ?></td>
        ...
        <div class="report-footer">
            ...
            <div>Total Records: <?php echo count($reportData); ?></div>
        </div>
    </div>
</div>
