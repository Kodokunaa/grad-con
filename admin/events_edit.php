    ...
    if ($title === "" || $content === "") {
        ...
        if ($remove_image === 1) {
            if (!empty($newImageName)) {
                $oldPath = __DIR__ . "/../uploads/events/" . $newImageName;
...
<div class="content">
    <div class="page-header">
        ...
        <a class="back-btn" href="<?php echo BASE_URL; ?>/admin/events_list.php">Back</a>
    </div>
        ...
        <form method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea
                    ...
                    required
                ><?php echo htmlspecialchars($event["content"] ?? ""); ?></textarea>
            </div>
            ...
            <?php if (!empty($event["image"])): ?>
                <div class="image-preview-wrap">
                    ...
                    <img
                        src="<?php echo BASE_URL; ?>/uploads/events/<?php echo htmlspecialchars($event["image"]); ?>"
            ...
            <div class="actions">
                ...
                <a class="btn-outline-custom" href="<?php echo BASE_URL; ?>/admin/events_list.php">Cancel</a>
            </div>
