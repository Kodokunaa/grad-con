...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST["delete_account"])) {
    try {
        ...
        header("Location: " . BASE_URL . "/admin/alumni_list.php?msg=Alumni deleted successfully");
        exit;
    } catch (Exception $e) {
        $error = "Error deleting alumni: " . $e->getMessage();
    }
}
...
<div class="content">
    ...
    <div class="page-header">
        ...
        <a class="back-btn" href="<?php echo BASE_URL; ?>/admin/alumni_list.php">Back to Alumni List</a>
    </div>
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <select class="form-select-custom" name="is_active">
                        ...
                        <option value="0" <?php echo ((int)$user['is_active'] === 0 ? 'selected' : ''); ?>>Disabled</option>
                    </select>
                </div>
                ...
                <div class="col-12 actions">
                    ...
                    <a class="btn-outline-custom" href="<?php echo BASE_URL; ?>/admin/alumni_list.php">Cancel</a>
        ...
        <div class="modal-content" style="border-radius: 16px; border: none;">
            ...
            <div class="modal-body" style="padding: 20px;">
                ...
                <p style="color: #6b7280; font-size: 14px;">
                    <strong><?php echo htmlspecialchars($user['fullname']); ?></strong> will be permanently removed from the system. This action cannot be undone.
                </p>
            </div>
