...
<div class="content">
    ...
    <div class="page-header">
        ...
        <a class="post-btn" href="<?php echo BASE_URL; ?>/admin/jobs_create.php">Post Job</a>
    </div>
                    ...
                    <div class="job-card">
                        ...
                        <div class="d-flex justify-content-between align-items-start gap-3">
                            <div>
                                ...
                                <div class="job-meta">
                                    Type: <?php echo htmlspecialchars($j['job_type']); ?> •
                                    Posted by: <?php echo htmlspecialchars($j['poster']); ?>
                                </div>

                                <div class="job-meta">
                                    Assigned Employer:
                                    <?php echo htmlspecialchars($j['employer_name'] ?? 'Not Assigned'); ?>
                                </div>
                        ...
                        <div class="job-actions">
                            <?php if ($isEmployerPosted): ?>
                                <a class="btn-outline-custom"
                                   href="<?php echo BASE_URL; ?>/admin/applications.php?job_id=<?php echo (int)$j['id']; ?>&readonly=1">
                                    Monitor Applications
                                </a>
                            <?php else: ?>
                                <a class="btn-orange"
                                   href="<?php echo BASE_URL; ?>/admin/applications.php?job_id=<?php echo (int)$j['id']; ?>">
                                    View Applications
                                </a>
                            <?php endif; ?>
                        </div>
    ...
    <div class="back-wrap">
        <a class="back-link" href="<?php echo BASE_URL; ?>/admin/dashboard.php">← Back to Dashboard</a>
    </div>
