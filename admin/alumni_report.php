...
$batchFilter  = trim($_GET['batch_year'] ?? '');
...
<div class="content">
    <div class="page-header no-print">
        ...
        <div class="top-actions">
            <a class="action-btn" href="<?php echo BASE_URL; ?>/admin/alumni_list.php">Back</a>
    ...
    <div class="summary-card">
        <div class="summary-grid">
            <div class="summary-box">
                ...
                <div class="summary-value"><?php echo $totalAlumni; ?></div>
            </div>
        </div>
    </div>
    ...
    <div class="report-card">
                    ...
                    <tbody>
                        <?php foreach ($alumni as $index => $a): ?>
                            <tr>
                                ...
                                <td><?php echo htmlspecialchars($a['batch_year'] ?? ''); ?></td>
                                <td>
                                    <?php
                                    echo !empty($a['created_at'])
                                        ? htmlspecialchars(date("M d, Y", strtotime($a['created_at'])))
                                        : '';
                                    ?>
                                </td>
                            </tr>
        ...
        <div class="report-footer">
            ...
            <div>Total Records: <?php echo count($alumni); ?></div>
        </div>
    </div>
</div>
