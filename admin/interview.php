...
$backUrl = BASE_URL . "/admin/applications.php?job_id=" . (int)$application['job_id'];
        ...
        <body style='font-family: Arial, sans-serif; background:#f8fafc; padding:20px;'>
            <div style='max-width:600px; margin:auto; background:white; border-radius:12px; padding:25px; border:1px solid #e5e7eb;'>
                ...
                <div style='background:#fff7ed; padding:15px; border-radius:10px; margin:20px 0;'>
                    ...
                    <p><strong>Location / Meeting Link:</strong> " . e($location) . "</p>
                </div>
...
<?php
if (file_exists(__DIR__ . "/../include/admin_sidebar.php")) {
    include __DIR__ . "/../include/admin_sidebar.php";
} elseif (file_exists(__DIR__ . "/../includes/admin_sidebar.php")) {
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <span class="badge"><?php echo e($interview['status']); ?></span>
                        </td>
                        <td>
