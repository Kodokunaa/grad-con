...
final class CreateAlumniOfficerRequest extends FormRequest
{
    ...
    {
        $this->merge(['fullname' => trim((string) $this->fullname), 'email' => trim((string) $this->email), 'username' => trim((string) $this->username), 'password_confirmation' => $this->input('confirm_password')]);
    }
