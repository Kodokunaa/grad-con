...
final class CreateEmployerRequest extends FormRequest
{
    ...
    protected function prepareForValidation(): void { $this->merge(['fullname' => trim((string) $this->fullname), 'company' => trim((string) $this->company), 'email' => trim((string) $this->email), 'username' => trim((string) $this->username)]); }
