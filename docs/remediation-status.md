...
|---|---|---|---|
| Critical architecture | In progress | Native authentication; initial report/list controllers; native redirects; Eloquent event create/edit/archive/restore/delete | Remaining PDO controllers, `PageContext`, `PageResponse`, global helpers, and `page-functions.php` |
...
| Validation | In progress | Auth validation plus Form Requests for administrative employer, officer, alumni creation/editing, resume forwarding, events, and training | Add Form Requests for jobs, remaining application actions, offers, interviews, profiles, education, employment, and social actions |
