...
| Validation | In progress | Auth validation plus Form Requests for administrative employer, officer, alumni creation/editing, and resume forwarding | Add Form Requests for jobs, remaining application actions, offers, interviews, events, training, profiles, education, employment, and social actions |
