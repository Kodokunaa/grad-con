...
| Validation | In progress | Auth validation plus Form Requests for administrative employer, officer, alumni creation/editing, resume forwarding, and event creation/editing | Add Form Requests for jobs, remaining application actions, offers, interviews, training, profiles, education, employment, and social actions |
...
| Mail and queues | In progress | Laravel queued delivery; reset notification; dedicated disk-backed applicant-resume Mailable; configured sender addresses; removal of PHPMailer transport setup | Replace remaining compatibility messages; consolidate templates; document/verify worker and SMTP deployment |
